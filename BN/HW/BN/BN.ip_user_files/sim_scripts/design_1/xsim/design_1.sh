...
xv_boost_lib_path=E:/programs/Xilinx/Vivado/2019.1/tps/boost_1_64_0
...
simulate()
{
  xsim design_1 -key {Behavioral:sim_1:Functional:design_1} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_afc3.protoinst" -protoinst "protoinst_files/bd_a878.protoinst" -protoinst "protoinst_files/bd_a888.protoinst" -protoinst "protoinst_files/bd_68d9.protoinst" -protoinst "protoinst_files/design_1.protoinst" -log simulate.log
}
...
{
  file="xsim.ini"
  lib_map_path="E:/programs/Xilinx/Vivado/2019.1/data/xsim"
  if [[ ($1 != "") ]]; then
    lib_map_path="$1"
  fi
