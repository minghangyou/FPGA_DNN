...
// ==============================================================
#ifndef __bn_ama_submuladd_cud__HH__
#define __bn_ama_submuladd_cud__HH__
...
template<
    ...
    int din3_WIDTH,
    int dout_WIDTH>
SC_MODULE(bn_ama_submuladd_cud) {
    ...
    SC_CTOR(bn_ama_submuladd_cud):  simcore_ama_0_U ("simcore_ama_0_U") {
