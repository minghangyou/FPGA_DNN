...
// ==============================================================
#ifndef __bn_sdiv_44s_14ns_bkb__HH__
#define __bn_sdiv_44s_14ns_bkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(bn_sdiv_44s_14ns_bkb) {
    ...
    SC_CTOR(bn_sdiv_44s_14ns_bkb):  ACMP_sdiv_seq_U ("ACMP_sdiv_seq_U") {
