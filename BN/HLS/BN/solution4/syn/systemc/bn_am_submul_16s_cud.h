...
// ==============================================================
#ifndef __bn_am_submul_16s_cud__HH__
#define __bn_am_submul_16s_cud__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(bn_am_submul_16s_cud) {
    ...
    SC_CTOR(bn_am_submul_16s_cud):  simcore_am_0_U ("simcore_am_0_U") {
