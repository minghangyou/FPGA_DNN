...
set Interfaces {
    s_axi_CTRL {
        ...
        registers {{0x00 CTRL       RW   0x0 "Control signals" {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 24 RESERVED_2 R 0 "Reserved.  0s on read." }}} {0x04 GIER       RW   0x0 "Global Interrupt Enable Register" {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }} } {0x08 IP_IER     RW   0x0 "IP Interrupt Enable Register" {{ 0 1 CHAN0_INT_EN RW 0 "Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled." } { 1 1 CHAN1_INT_EN RW 0 "Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled." } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x0c IP_ISR     RW   0x0 "IP Interrupt Status Register" {{ 0 1 CHAN0_INT_ST RTOW 0 "Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 input interrupt, 1 = Channel 0 input interrup" } { 1 1 CHAN1_INT_ST RTOW 0 "Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 input interrupt, 1 = Channel 1 input interrup" } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x10 in_V W 0x0 "Data signal of in_V" {{0 32 in_V W 0 "Bit 31 to 0 Data signal of in_V"}}} {0x18 beta_V W 0x0 "Data signal of beta_V" {{0 32 beta_V W 0 "Bit 31 to 0 Data signal of beta_V"}}} {0x20 gamma_V W 0x0 "Data signal of gamma_V" {{0 32 gamma_V W 0 "Bit 31 to 0 Data signal of gamma_V"}}} {0x28 moving_mean_V W 0x0 "Data signal of moving_mean_V" {{0 32 moving_mean_V W 0 "Bit 31 to 0 Data signal of moving_mean_V"}}} {0x30 moving_variance_V W 0x0 "Data signal of moving_variance_V" {{0 32 moving_variance_V W 0 "Bit 31 to 0 Data signal of moving_variance_V"}}} {0x38 out_V W 0x0 "Data signal of out_V" {{0 32 out_V W 0 "Bit 31 to 0 Data signal of out_V"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
    ...
    ap_clk {
        ...
        buses "s_axi_CTRL m_axi_IN_r m_axi_BETA m_axi_GAMMA m_axi_M_M m_axi_M_V m_axi_OUT_r"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
    ...
    m_axi_BETA {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_BETA"
        data_width "32"
        param_prefix "C_M_AXI_BETA"
        port_width "AWADDR 32 AWID 1 AWUSER 1 WDATA 32 WSTRB 4 WID 1 WUSER 1 ARADDR 32 ARID 1 ARUSER 1 RDATA 32 RID 1 RUSER 1 BID 1 BUSER 1"
        ctype {
            AWLEN {
                Type "integer unsigned"
    ...
    m_axi_GAMMA {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_GAMMA"
        data_width "32"
        param_prefix "C_M_AXI_GAMMA"
        port_width "AWADDR 32 AWID 1 AWUSER 1 WDATA 32 WSTRB 4 WID 1 WUSER 1 ARADDR 32 ARID 1 ARUSER 1 RDATA 32 RID 1 RUSER 1 BID 1 BUSER 1"
        ctype {
            AWLEN {
                Type "integer unsigned"
    ...
    m_axi_M_M {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_M_M"
        data_width "32"
        param_prefix "C_M_AXI_M_M"
        port_width "AWADDR 32 AWID 1 AWUSER 1 WDATA 32 WSTRB 4 WID 1 WUSER 1 ARADDR 32 ARID 1 ARUSER 1 RDATA 32 RID 1 RUSER 1 BID 1 BUSER 1"
        ctype {
            AWLEN {
                Type "integer unsigned"
    ...
    m_axi_M_V {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_M_V"
        data_width "32"
        param_prefix "C_M_AXI_M_V"
        port_width "AWADDR 32 AWID 1 AWUSER 1 WDATA 32 WSTRB 4 WID 1 WUSER 1 ARADDR 32 ARID 1 ARUSER 1 RDATA 32 RID 1 RUSER 1 BID 1 BUSER 1"
        ctype {
            AWLEN {
                Type "integer unsigned"
