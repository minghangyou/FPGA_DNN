...
set C_modelArgList {
	...
	{ BETA int 16 regular {axi_master 0}  }
	{ GAMMA int 16 regular {axi_master 0}  }
	{ M_M int 16 regular {axi_master 0}  }
	{ M_V int 16 regular {axi_master 0}  }
...
set C_modelArgMapList {[ 
	{ "Name" : "IN_r", "interface" : "axi_master", "bitwidth" : 16, "direction" : "READONLY", "bitSlice":[{"low":0,"up":15,"cElement": [{"cName": "in.V","cData": "uint16","bit_use": { "low": 0,"up": 15},"offset": { "type": "dynamic","port_name": "in_V","bundle": "AXILiteS"},"direction": "READONLY","cArray": [{"low" : 0,"up" : 99998,"step" : 1}]}]}]} , 
 	{ "Name" : "BETA", "interface" : "axi_master", "bitwidth" : 16, "direction" : "READONLY", "bitSlice":[{"low":0,"up":15,"cElement": [{"cName": "beta.V","cData": "uint16","bit_use": { "low": 0,"up": 15},"offset": { "type": "dynamic","port_name": "beta_V","bundle": "AXILiteS"},"direction": "READONLY","cArray": [{"low" : 0,"up" : 99998,"step" : 1}]}]}]} , 
 	{ "Name" : "GAMMA", "interface" : "axi_master", "bitwidth" : 16, "direction" : "READONLY", "bitSlice":[{"low":0,"up":15,"cElement": [{"cName": "gamma.V","cData": "uint16","bit_use": { "low": 0,"up": 15},"offset": { "type": "dynamic","port_name": "gamma_V","bundle": "AXILiteS"},"direction": "READONLY","cArray": [{"low" : 0,"up" : 99998,"step" : 1}]}]}]} , 
 	{ "Name" : "M_M", "interface" : "axi_master", "bitwidth" : 16, "direction" : "READONLY", "bitSlice":[{"low":0,"up":15,"cElement": [{"cName": "moving_mean.V","cData": "uint16","bit_use": { "low": 0,"up": 15},"offset": { "type": "dynamic","port_name": "moving_mean_V","bundle": "AXILiteS"},"direction": "READONLY","cArray": [{"low" : 0,"up" : 99998,"step" : 1}]}]}]} , 
 	{ "Name" : "M_V", "interface" : "axi_master", "bitwidth" : 16, "direction" : "READONLY", "bitSlice":[{"low":0,"up":15,"cElement": [{"cName": "moving_variance.V","cData": "uint16","bit_use": { "low": 0,"up": 15},"offset": { "type": "dynamic","port_name": "moving_variance_V","bundle": "AXILiteS"},"direction": "READONLY","cArray": [{"low" : 0,"up" : 99998,"step" : 1}]}]}]} , 
 	{ "Name" : "OUT_r", "interface" : "axi_master", "bitwidth" : 16, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":15,"cElement": [{"cName": "out.V","cData": "uint16","bit_use": { "low": 0,"up": 15},"offset": { "type": "dynamic","port_name": "out_V","bundle": "AXILiteS"},"direction": "WRITEONLY","cArray": [{"low" : 0,"up" : 99998,"step" : 1}]}]}]} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "8", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_sqrt_fixed_16_6_s_fu_303", "Parent" : "0",
	...
	{"ID" : "9", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.bn_sdiv_27ns_14nsbkb_U2", "Parent" : "0"},
	{"ID" : "10", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.bn_am_submul_16s_cud_U3", "Parent" : "0"}]}
