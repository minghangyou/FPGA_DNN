...
// ==============================================================
#ifndef __bn_mul_mul_13ns_1bkb__HH__
#define __bn_mul_mul_13ns_1bkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(bn_mul_mul_13ns_1bkb) {
    ...
    SC_CTOR(bn_mul_mul_13ns_1bkb):  ACMP_smul_us_U ("ACMP_smul_us_U") {
