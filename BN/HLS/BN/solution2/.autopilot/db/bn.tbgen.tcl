...
set C_modelArgList {
	{ IN_r int 64 regular {axi_master 0}  }
	{ BETA int 64 regular {axi_master 0}  }
	{ GAMMA int 64 regular {axi_master 0}  }
	{ M_M int 64 regular {axi_master 0}  }
	{ M_V int 64 regular {axi_master 0}  }
...
set C_modelArgMapList {[ 
	{ "Name" : "IN_r", "interface" : "axi_master", "bitwidth" : 64, "direction" : "READONLY", "bitSlice":[{"low":0,"up":63,"cElement": [{"cName": "in.V","cData": "uint64","bit_use": { "low": 0,"up": 63},"offset": { "type": "dynamic","port_name": "in_V","bundle": "AXILiteS"},"direction": "READONLY","cArray": [{"low" : 0,"up" : 99998,"step" : 1}]}]}]} , 
 	{ "Name" : "BETA", "interface" : "axi_master", "bitwidth" : 64, "direction" : "READONLY", "bitSlice":[{"low":0,"up":63,"cElement": [{"cName": "beta.V","cData": "uint64","bit_use": { "low": 0,"up": 63},"offset": { "type": "dynamic","port_name": "beta_V","bundle": "AXILiteS"},"direction": "READONLY","cArray": [{"low" : 0,"up" : 99998,"step" : 1}]}]}]} , 
 	{ "Name" : "GAMMA", "interface" : "axi_master", "bitwidth" : 64, "direction" : "READONLY", "bitSlice":[{"low":0,"up":63,"cElement": [{"cName": "gamma.V","cData": "uint64","bit_use": { "low": 0,"up": 63},"offset": { "type": "dynamic","port_name": "gamma_V","bundle": "AXILiteS"},"direction": "READONLY","cArray": [{"low" : 0,"up" : 99998,"step" : 1}]}]}]} , 
 	{ "Name" : "M_M", "interface" : "axi_master", "bitwidth" : 64, "direction" : "READONLY", "bitSlice":[{"low":0,"up":63,"cElement": [{"cName": "moving_mean.V","cData": "uint64","bit_use": { "low": 0,"up": 63},"offset": { "type": "dynamic","port_name": "moving_mean_V","bundle": "AXILiteS"},"direction": "READONLY","cArray": [{"low" : 0,"up" : 99998,"step" : 1}]}]}]} , 
 	{ "Name" : "M_V", "interface" : "axi_master", "bitwidth" : 64, "direction" : "READONLY", "bitSlice":[{"low":0,"up":63,"cElement": [{"cName": "moving_variance.V","cData": "uint64","bit_use": { "low": 0,"up": 63},"offset": { "type": "dynamic","port_name": "moving_variance_V","bundle": "AXILiteS"},"direction": "READONLY","cArray": [{"low" : 0,"up" : 99998,"step" : 1}]}]}]} , 
 	{ "Name" : "OUT_r", "interface" : "axi_master", "bitwidth" : 64, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":63,"cElement": [{"cName": "out.V","cData": "uint64","bit_use": { "low": 0,"up": 63},"offset": { "type": "dynamic","port_name": "out_V","bundle": "AXILiteS"},"direction": "WRITEONLY","cArray": [{"low" : 0,"up" : 99998,"step" : 1}]}]}]} , 
...
set portList { 
	...
	{ m_axi_IN_r_WDATA sc_out sc_lv 64 signal 0 } 
	{ m_axi_IN_r_WSTRB sc_out sc_lv 8 signal 0 } 
	...
	{ m_axi_IN_r_RDATA sc_in sc_lv 64 signal 0 } 
	...
	{ m_axi_BETA_WDATA sc_out sc_lv 64 signal 1 } 
	{ m_axi_BETA_WSTRB sc_out sc_lv 8 signal 1 } 
	...
	{ m_axi_BETA_RDATA sc_in sc_lv 64 signal 1 } 
	...
	{ m_axi_GAMMA_WDATA sc_out sc_lv 64 signal 2 } 
	{ m_axi_GAMMA_WSTRB sc_out sc_lv 8 signal 2 } 
	...
	{ m_axi_GAMMA_RDATA sc_in sc_lv 64 signal 2 } 
	...
	{ m_axi_M_M_WDATA sc_out sc_lv 64 signal 3 } 
	{ m_axi_M_M_WSTRB sc_out sc_lv 8 signal 3 } 
	...
	{ m_axi_M_M_RDATA sc_in sc_lv 64 signal 3 } 
	...
	{ m_axi_M_V_WDATA sc_out sc_lv 64 signal 4 } 
	{ m_axi_M_V_WSTRB sc_out sc_lv 8 signal 4 } 
	...
	{ m_axi_M_V_RDATA sc_in sc_lv 64 signal 4 } 
	...
	{ m_axi_OUT_r_WDATA sc_out sc_lv 64 signal 5 } 
	{ m_axi_OUT_r_WSTRB sc_out sc_lv 8 signal 5 } 
	...
	{ m_axi_OUT_r_RDATA sc_in sc_lv 64 signal 5 } 
...
set NewPortList {[ 
	...
	{ "name": "interrupt", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "CTRL", "role": "interrupt" } }, 
 	...
 	{ "name": "m_axi_IN_r_WDATA", "direction": "out", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "IN_r", "role": "WDATA" }} , 
 	{ "name": "m_axi_IN_r_WSTRB", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "IN_r", "role": "WSTRB" }} , 
 	...
 	{ "name": "m_axi_IN_r_RDATA", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "IN_r", "role": "RDATA" }} , 
 	...
 	{ "name": "m_axi_BETA_WDATA", "direction": "out", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "BETA", "role": "WDATA" }} , 
 	{ "name": "m_axi_BETA_WSTRB", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "BETA", "role": "WSTRB" }} , 
 	...
 	{ "name": "m_axi_BETA_RDATA", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "BETA", "role": "RDATA" }} , 
 	...
 	{ "name": "m_axi_GAMMA_WDATA", "direction": "out", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "GAMMA", "role": "WDATA" }} , 
 	{ "name": "m_axi_GAMMA_WSTRB", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "GAMMA", "role": "WSTRB" }} , 
 	...
 	{ "name": "m_axi_GAMMA_RDATA", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "GAMMA", "role": "RDATA" }} , 
 	...
 	{ "name": "m_axi_M_M_WDATA", "direction": "out", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "M_M", "role": "WDATA" }} , 
 	{ "name": "m_axi_M_M_WSTRB", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "M_M", "role": "WSTRB" }} , 
 	...
 	{ "name": "m_axi_M_M_RDATA", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "M_M", "role": "RDATA" }} , 
 	...
 	{ "name": "m_axi_M_V_WDATA", "direction": "out", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "M_V", "role": "WDATA" }} , 
 	{ "name": "m_axi_M_V_WSTRB", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "M_V", "role": "WSTRB" }} , 
 	...
 	{ "name": "m_axi_M_V_RDATA", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "M_V", "role": "RDATA" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "8", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_sqrt_fixed_16_6_s_fu_556", "Parent" : "0",
	...
	{"ID" : "9", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.bn_mul_mul_13ns_1bkb_U2", "Parent" : "0"},
	{"ID" : "10", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.bn_mul_mul_13ns_1bkb_U3", "Parent" : "0"},
	{"ID" : "11", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.bn_mul_mul_13ns_1bkb_U4", "Parent" : "0"},
	{"ID" : "12", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.bn_mul_mul_13ns_1bkb_U5", "Parent" : "0"}]}


set ArgLastReadFirstWriteLatency {
	bn {
		IN_r {Type I LastRead 12 FirstWrite -1}
		BETA {Type I LastRead 12 FirstWrite -1}
		GAMMA {Type I LastRead 12 FirstWrite -1}
		M_M {Type I LastRead 12 FirstWrite -1}
		M_V {Type I LastRead 12 FirstWrite -1}
		OUT_r {Type O LastRead 28 FirstWrite 24}
